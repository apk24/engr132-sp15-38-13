...
% Last Modified by GUIDE v2.5 14-Apr-2015 10:51:49
...
handles.data.openGUI = 'ndim_plot_akharche';
...
yitem = aNames(2, get(handles.y_axis_pm, 'Value'));
zitem = aNames(2, get(handles.z_axis_pm, 'Value'));
handles.data = getappdata(0, 'data');
if(xstep)
    yvals = linspace(0,0,length(xstep));
    zvals = yvals;
    xvals = xstep;
    recipe = handles.data.recipe;
    for ct = xstep
